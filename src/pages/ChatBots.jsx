...
const ChatBots = () => {
  const pageData = getPageData('chatbots');

  return (
    <PageTemplate pageKey="chatbots" containerFluid>
      {/* Hero Section */}
      <section
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center mb-5">
              <h2 className="f-32 f-700 black">Why Choose Our Chatbots?</h2>
            </div>
          </div>
          <div className="row">
      ...
      <section className="py-5 bg-light">
        <div className="container text-center">
          <h2 className="f-32 f-700 black mb-3">Ready to Deploy Your Multilingual Chatbot?</h2>
          <p className="f-18 f-400 gray mb-4">
            Start engaging customers in their preferred language today
          </p>
          <Link to="/book-a-demo">
            <button className="devnagri-btn">Get Started</button>
          </Link>
        </div>
      </section>
    </PageTemplate>
